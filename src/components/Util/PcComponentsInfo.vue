  ...
  <section class="bg-white w-full h-full ml-6 p-8">
    ...
    <div v-if="route.params.type === 'cpu'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Chipset Support</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-else-if="route.params.type === 'gpu'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Power Connector</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-if="route.params.type === 'ssd'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Memory Modules</div>
        <div class="col-span-2 p-3 border-solid border-2">
          {{ itemComponent['memory-modules'] }}
        </div>
        <div class="font-bold bg-slate-300 p-3 text-black">Endurance (TBW)</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-if="route.params.type === 'psu'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Input Frequency</div>
        <div class="col-span-2 p-3 border-solid border-2">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">PCIE Connector</div>
        <div class="col-span-2 p-3 border-solid border-2">
          {{ itemComponent['pcie-connector'] }}
        </div>
        <div class="font-bold bg-slate-300 p-3 text-black">SATA Connector</div>
        <div class="col-span-2 p-3 border-solid border-2">
          {{ itemComponent['sata-connector'] }}
        </div>
        <div class="font-bold bg-slate-300 p-3 text-black">MOLEX Connector</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-if="route.params.type === 'case'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="col-span-2 p-3 border-solid border-2">
          ...
          {{ itemComponent['cooling-support']['fan-support']['rear'] }}, Side :
          {{ itemComponent['cooling-support']['fan-support']['side'] }}, Bottom
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Max Vga Length</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-if="route.params.type === 'monitor'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Max Resolution</div>
        <div class="col-span-2 p-3 border-solid border-2">
    ...
    <div v-if="route.params.type === 'mainboard'">
      ...
      <div class="grid grid-cols-3">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Memory Support</div>
        <div class="col-span-2 p-3 border-solid border-2">
        ...
        <div class="font-bold bg-slate-300 p-3 text-black">Audio Channels</div>
        <div class="col-span-2 p-3 border-solid border-2">
